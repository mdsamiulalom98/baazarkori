...
class Category extends Model
{
    ...
    public function subcategories() {
        return $this->hasMany(Subcategory::class, 'category_id')->where('status', 1)->orderBy('sort','ASC');
    }
    ...
    {
        return $this->hasMany(Product::class, 'category_id')->select('id', 'name', 'slug', 'category_id', 'new_price', 'old_price','stock','specification')->orderBy('id','DESC');
    }
