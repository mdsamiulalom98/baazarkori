...
class Product extends Model
{
    ...
    {
        return $this->hasMany(Review::class, 'product_id')->select('id', 'product_id', 'ratting');
    }
    ...
    {
        return $this->hasMany('App\Models\OrderDetails', 'product_id', 'id')->select('id', 'product_id', 'order_id');
    }
    ...
    // {
    //     return $this->belongsTo(Seller::class, 'seller_id')->select('name', 'id', 'slug', 'address', 'image', 'banner');
    // }
    public function seller()
    {
