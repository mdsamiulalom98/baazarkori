...
class ChildcategoryController extends Controller
{
    ...
    //         Toastr::warning('No records found to update', 'Warning');
    //         return redirect()->back();
    //     }

    //     $sortValue = 151;
    //     foreach ($categories as $category) {
    //         $category->update(['sort' => $sortValue]);
    //         $sortValue--;
    //     }
    ...
    {
        $data = Childcategory::orderBy('sort','DESC')->with('subcategory')->get();
