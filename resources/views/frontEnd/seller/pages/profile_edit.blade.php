        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('seller.profile_update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <!-- col end -->
                    @if(empty($profile_edit->owner_name) || empty($profile_edit->name) || empty($profile_edit->phone) || empty($profile_edit->email) || empty($profile_edit->address) || empty($profile_edit->nidnum) || empty($profile_edit->district) || empty($profile_edit->area) || empty($profile_edit->image) || empty($profile_edit->nid1) || empty($profile_edit->nid2))
                        <div>
