                        ...
                        <!-- end-col -->
                            ...
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('new_price') is-invalid @enderror"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        name="whole_sell_price" value="{{ old('whole_sell_price') }}"
                            ...
                            <!--  <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="min_qty" class="form-label">Min Quantity (Optional)</label>
                                    <input type="text" class="form-control @error('min_qty') is-invalid @enderror"
                            ...
                            <div class="col-sm-3 mb-3">
                                ...
                                <div class="clone hide" style="display: none;">
                                    <div class="control-group input-group btn-increment">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pro_video') is-invalid @enderror"
                                        name="pro_unit" value="{{ old('pro_video') }}" id="pro_video" />
                                    @error('pro_video')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-4 mb-3">
                                <div class="form-group mb-3">
                                   ...
                                   <select name="warranty" class="form-control select2">
                                        ...
                                        <option value="365 days warranty" >365 Days Warranty</option>
                                        <option value="money back guaranty" >Money Back Guaranty</option>
                                    </select>
                                    @error('warranty')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="specification" rows="6"
                                        class="summernote form-control @error('specification') is-invalid @enderror"></textarea>
                                    @error('specification')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    <label for="sort_description" class="form-label">Short Description  (Optional)</label>
                                    <textarea name="sort_description" rows="6"
                                        class="summernote form-control @error('sort_description') is-invalid @enderror"></textarea>
...
@push('script')
    ...
    $(document).ready(function() {
        $(".btn-increment").click(function() {
            var newInput = $(".clone").html(); // Grab HTML from clone
            $(".increment").after(newInput); // Insert after increment group
        });
