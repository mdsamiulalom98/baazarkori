    ...
    <section class="seller-des">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 text-center">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-" id="exampleModalToggleLabel">Commission & Conditions Rules</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                আপনার প্রতি প্রোডাক্ট এর মূল্য এর উপর {{ Auth::guard('seller')->user()->commision }} পার্সেন্ট
                                টাকা কাটা হবে
                            </div>
                ...
                <button class="btn btn-success mt-lg-3 mt-sm-1" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Commission
                    & Conditions</button>
                <!-- modal-end -->
            </div>
        ...
        <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span
                                                data-plugin="counterup">{{ Auth::guard('seller')->user()->balance }}</span>
                                        </h3>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="short-dashboard card">
                    <div class="card-body">
                        <a href="{{route('seller.sellerearn')}}">
                            <div class="row">
                                <div class="col-6">
                                    <div
                                        class="avatar-lg dash-round front-dash bg-primary bg-gradient bg-opacity-25 border-primary border">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span
                                                data-plugin="counterup">{{ $total_earning }}</span></h3>
                        ...
                        <a href="{{ route('seller.sellerexpense') }}">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span
                                                data-plugin="counterup">{{$duesellerTotal}}</span>
                                        </h3>
                                        <p class="text-end mb-1 dashborad-text">Expense</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </a>
