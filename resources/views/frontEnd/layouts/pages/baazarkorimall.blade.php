...
@section('title','Baazarkori Mall Products')
@push('css')
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="category-breadcrumb d-flex align-items-center">
                        ...
                        <span>/</span>
                        <strong>Baazarkori Mall Products</strong>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="showing-data">
                                <span>Showing {{ $baazarkorimall->firstItem() }}-{{ $baazarkorimall->lastItem() }} of {{ $baazarkorimall->total() }} Results</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="product-sliders main_product_inner">
                    @foreach($baazarkorimall as $key=>$value)
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="custom_paginate">
                    {{$baazarkorimall->links('pagination::bootstrap-4')}}
