...
@section('title','Top Rated Product')
@push('css')
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="category-breadcrumb d-flex align-items-center">
                        ...
                        <span>/</span>
                        <strong>Top Rated Product</strong>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="showing-data">
                                <span>Showing {{ $toprated->firstItem() }}-{{ $toprated->lastItem() }} of {{ $toprated->total() }} Results</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="custom_paginate">
                    {{$toprated->links('pagination::bootstrap-4')}}
