                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p>{{ $order->shipping?->name ?? 'No Shipping Information' }}</p>
                                        <p>{{ $order->shipping?->phone ?? 'No Shipping Information' }}</p>
                                        <p>{{ $order->shipping?->address ?? 'No Shipping Information' }}</p>
                                        <p>{{ $order->shipping?->area ?? 'No Shipping Information' }}</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
