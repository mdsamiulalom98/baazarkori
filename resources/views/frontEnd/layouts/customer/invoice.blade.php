        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="text-center mb-3">
                     <a  href="https://merchant.pathao.com/tracking?consignment_id={{$order->consignment_id}}&phone={{$order->shipping?$order->shipping->phone:''}}" target="_blank" class="{{ $order->courier ? 'btn btn-primary' : '' }}">Pathao Track</a>
                </div>
                @endif              
