                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4  mt-3">
                        <div class="info-box bg-secondary">
                          <span class="info-box-icon"><i class="fe-cast"></i></span>
            
                          <div class="info-box-content">
                            <span class="info-box-text">Total Income</span>
                            <span class="info-box-number">{{$total_income}} Tk</span>
                      ...
                      <div class="col-sm-4 mt-3">
                        <div class="info-box bg-info">
                          ...
                          <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{($total_sales+$total_income) - ($total_purchase+$total_expense)}} Tk</span>
