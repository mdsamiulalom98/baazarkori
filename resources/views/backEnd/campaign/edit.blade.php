                ...
                <form action="{{route('campaign.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data" name="editForm">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            <label for="banner" class="form-label">Banner Image (1360x580px)</label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('pro_title') is-invalid @enderror" name="pro_title" value="{{ $edit_data->pro_title}}"  id="pro_title" required="">
                            @error('pro_title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="form-group">
                            <label for="image_one" class="form-label">Image One(330x330px)</label>
                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="form-group">
                            <label for="image_two" class="form-label">Image Two(330x330px)</label>
                    ...
                    <div class="col-sm-4 mb-3">
                        <div class="form-group">
                            <label for="image_three" class="form-label">Image Three(330x330px)</label>
                    ...
                    <!-- col-end -->
                    <div class="col-sm-6 mb-3">
                        <label for="image">Review Image (215x230px)*</label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('necessity_title') is-invalid @enderror" name="necessity_title" value="{{$edit_data->necessity_title}}"  id="necessity_title" required="">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('rules') is-invalid @enderror" name="rules" value="{{$edit_data->rules}}"  id="rules" required="">
                            @error('rules')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 my-3">
                        <div class="form-group">
                            ...
                            <textarea name="rules_description"  rows="6" class="summernote form-control @error('rules_description') is-invalid @enderror" >{{$edit_data->rules_description}}</textarea>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            <label for="whychoose_img" class="form-label">Why Choose Image(500x500px)</label>
                            <input type="file" class="form-control @error('whychoose_img') is-invalid @enderror " name="whychoose_img"  value="{{ $edit_data->whychoose_img }}"  id="whychoose_img">
