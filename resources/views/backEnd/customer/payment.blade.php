    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{request()->status}} Payment</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                ...
                <div class="table-responsive ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@if($value->customer->seller_type==1)Uddokta @else Reseller @endif</td>
                            <td>{{$value->amount}}</td>
                            ...
                            <td>
                                <div class="button-list">                                 
                                    ...
                                    <a href="{{route('customers.payment.show',['id'=>$value->id])}}" class="btn btn-xs btn-blue waves-effect waves-light"><i class="fe-eye"></i></a>                                  
