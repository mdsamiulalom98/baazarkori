            ...
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <li><a data-bs-toggle="modal" data-bs-target="#cutammount" class="btn rounded-pill btn-primary"><i class="fe-minus"></i> Amount Minus</a></li>
                     <!-- amount plus-start -->
                     <li><a data-bs-toggle="modal" data-bs-target="#addammount" class="btn rounded-pill btn-secondary mt-3"><i class="fe-plus"></i> Add Amount </a></li>
                     <!-- amount plus-end -->
                     <!-- Assign User End -->
                        <div class="modal fade" id="cutammount" tabindex="-1">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <form action="{{route('customers.storecus')}}" id="order_status_form" method="post">
                                @csrf
                     ...
                     <!-- add amound start -->
                     <div class="modal fade" id="addammount" tabindex="-1">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title">Amount Plus Note</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <form action="{{route('customers.addstorecus')}}" id="order_status_form" method="post">
                                @csrf
                                <input type="hidden" name="customer_id" value="{{$profile->id}}">
                              <div class="modal-body">
                                <!-- <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-3">
                                        <label for="amount" class="form-label">Amount rty*</label>
                                        <input type="number" class="form-control @error('amount') is-invalid @enderror"
                                            name="amount" value="{{ old('amount') }}" id="amount" required="" />
                                        @error('amount')
                                            <span class="invalid-feedback" role="alert">
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-pills nav-fill navtab-bg">
                        ...
                        <li class="nav-item mt-2">
                            <a href="#deductlist" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
                               Deduct List
                            </a>
                        </li>
                        <li class="nav-item mt-2">
                            <a href="#addamountlist" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
                               Add Amount List
                            </a>
                        </li>
                        <!--<li class="nav-item mt-2">-->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="deductlist">
                            <h4>Deduct List</h4>
                            <table class="table table-striped dt-responsive nowrap w-100 datatable2">
                                ...
                                <tbody>
                                    @foreach($profile->deducts as $key=>$value)
                                    <tr>
                                        <td>{{$loop->iteration}}</td>
                        ...
                        <!-- end  item-->
                        <div class="tab-pane" id="addamountlist">
                            <h4>Add Amount List</h4>
                            <table class="table table-striped dt-responsive nowrap w-100 datatable2">
                                <thead>
                                    <tr>
                                        <th>SL</th>
                                ...
                                <tbody>
                                    @foreach($profile->addamount as $key=>$value)
                                    <tr>
                                        <td>{{$loop->iteration}}</td>
                                        <td>{{$value->created_at->format('d-m-Y H:m a')}}</td>
                                        <td>{{$value->amount}}</td>
