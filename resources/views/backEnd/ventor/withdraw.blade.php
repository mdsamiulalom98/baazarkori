...
@section('title',$title.'Ventor Withdraw')
@section('css')
                ...
                <table id="content-to-export" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$value->seller?$value->seller->name:''}}</td>
                            <td>{{$value->method}}</td>
                            <td>{{$value->receive}}</td>
                            <td>{{$value->amount}}</td>
                            <td>{{$value->note}}</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
       ...
       <div class="modal-body">
           <form action="{{route('admin.ventorwithdraw_change')}}" method="POST">
            @csrf
            <input type="hidden" name="id" value="{{$value->id}}">
             ...
             <!-- <div class="form-group mb-3">
                 ...
                 <textarea name="note" class="form-control" required>{{$value->note}}</textarea>
             </div> -->
             <div class="form-group">
