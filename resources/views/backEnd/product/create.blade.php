                    ...
                    <form action="{{ route('products.store') }}" method="POST" class="row" data-parsley-validate=""
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control select2 @error('seller_id') is-invalid @enderror"
                                    name="seller_id" value="{{ old('seller_id') }}" id="seller_id" required>
                                    <option value="">Select..</option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('sold') is-invalid @enderror"
                                    name="sold" value="{{ old('sold') }}" id="sold" />
                                @error('sold')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
