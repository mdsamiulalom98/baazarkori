                ...
                <table id="datatable-buttons" class="table table-striped   w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong>{{$value->shipping?$value->shipping->name:''}}</strong><p><strong>Dis: </strong>{{$value->shipping?$value->shipping->district:''}},
                             <br><strong>Up:</strong>{{$value->shipping?$value->shipping->area:''}},<br><strong>Addr: </strong>{{$value->shipping?$value->shipping->address:''}}</p></td>
                            <td>{{$value->seller?$value->seller->name:'No'}}</td>
                            <td>{{$value->uddokta?$value->uddokta->name:'No'}}</td>
                    ...
                    <tfoot>
                        <tr>
                            @if($order_status->name == 'Completed')
                            <td colspan="9" class="text-end"><strong>Total Amount:</strong></td>
                            <td><strong>৳{{ number_format($show_total, 2) }}</strong></td>
                            @endif
                        </tr>
                    </tfoot>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
           ...
           <select name="pathaostore" id="pathaostore" class="chosen-select pathaocity form-control" >
