                    ...
                    <form action="{{route('admin.order.update')}}" method="POST" class="row pos_form" data-parsley-validate="" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-2">
                                        <input type="number" id="advance" class="form-control @error('advance') is-invalid @enderror" placeholder="Advance Payment" name="advance" value="{{$order->advance}}">
                                        @error('advance')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select id="area"
                                            class="form-control  area select2 @error('upazila') is-invalid @enderror"
                                            name="upazila" value="{{ old('upazila') }}" required>
                                             @foreach ($areas as $key => $value)
                                                <option value="{{ $value->area_name }}" {{$data->shipping->area == $value->area_name ? 'selected' :''}}>
