                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    @if($value->product_code !=NULL && $value->proCommission !=NULL)
                                    <form method="post" action="{{route('sellers.product_approve')}}" class="d-inline"> 
                                    @csrf
                                    <input type="hidden" value="{{$value->id}}" name="hidden_id">

                                    <button type="button" class="btn btn-xs  btn-secondary waves-effect waves-light change-confirm" title="Approve"><i class="fe-check"></i></button>
                                    </form>
                                    @else

                                    <a href="{{route('products.procode.edit',$value->id)}}" title="Approve" class="btn btn-xs btn-success waves-effect waves-light"><i class="fe-check"></i></a>
                                    @endif
