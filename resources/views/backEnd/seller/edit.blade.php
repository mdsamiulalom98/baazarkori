                ...
                <form action="{{route('sellers.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('commision') is-invalid @enderror" name="commision" value="{{ $edit_data->commision}}"  id="commision" >
                            @error('commision')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <!-- col-end -->
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select  id="district" class="form-control select2 district @error('district') is-invalid @enderror" name="district" value="{{ old('district') }}" >
                                <option value="">Select...</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <select  id="area" class="form-control area select2 @error('area') is-invalid @enderror" name="area" value="{{ old('area') }}" >
                                <option value="">Select...</option>
