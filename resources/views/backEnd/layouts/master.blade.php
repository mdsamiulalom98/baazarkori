        ...
        <div class="navbar-custom">
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-end mb-0">
                    ...
                    <!-- seller product notification start -->
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light"
                            href="{{ route('sellers.pending_product') }}">
                            <i data-feather="database"></i>
                            <span class="badge bg-danger rounded-circle noti-icon-badge">{{ $newsellerproduct }}</span>
                        </a>
                    </li>
                    <!-- seller product notification end -->
                    <!-- wallet-icon start -->
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light"
                            href="{{ route('wallet.index', ['status' => 'pending']) }}">
                            <i data-feather="credit-card"></i>
                            <span class="badge bg-danger rounded-circle noti-icon-badge">{{ $newwalletrequest }}</span>
                        </a>
                    </li>
                    <!-- wallet-icon end -->
                    {{-- cancelled --}}
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light" data-bs-toggle="dropdown"
                            ...
                            <span
                                class="badge bg-danger rounded-circle noti-icon-badge">{{ $cancelorder->count() }}</span>
                        </a>
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="m-0">
                                    <span class="float-end">
                                        <a href="{{ route('admin.orders', ['slug' => 'cancelled']) }}" class="text-dark">
                                ...
                                @foreach ($cancelorder as $order)
                                    ...
                                    <a href="{{ route('admin.orders', ['slug' => 'cancelled']) }}"
                                        ...
                                        <div class="notify-icon">
                                            <img src="{{ asset($order->customer ? $order->customer->image : '') }}"
                                                class="img-fluid rounded-circle" alt="" />
                                        </div>
                                        <p class="notify-details">{{ $order->customer ? $order->customer->name : '' }}</p>
                                        <p class="text-muted mb-0 user-msg">
                                            <small>Invoice : {{ $order->invoice_id }}</small>
                                        </p>
                                    </a>
                                @endforeach
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light"
                            href="{{ route('customers.payment', ['status' => 'pending']) }}">
                            <i class="fe-user noti-icon"></i>
                            <span class="badge bg-danger rounded-circle noti-icon-badge">{{ $newrequestall }}</span>
                        </a>
                    </li>
                ...
                <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                    ...
                    <li class="dropdown d-none d-xl-block">
                        <a class="nav-link dropdown-toggle waves-effect waves-light"
                            href="{{ route('admin.order.create') }}"> <i data-feather="shopping-cart"></i> Pos </a>
                    </li>
                </ul>
            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-seller">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('sellers.index', ['status' => 'pending']) }}">Pending
                                            Seller</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('sellers.index', ['status' => 'inactive']) }}">Inactive
                                            Seller</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('sellers.index', ['status' => 'active']) }}">Active Seller</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('sellers.pending_product') }}">Pending Product</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <!-- nav items -->
                        <li>
                            <a href="#sidebar-polyorder" data-bs-toggle="collapse">
                                <i data-feather="twitch"></i>
                                <span> Packaging Poly Orders </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-polyorder">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('polyorder.orders', ['status' => 'processing']) }}"><i
                                                data-feather="file-plus"></i> Processing Orders</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('polyorder.orders', ['status' => 'paid']) }}"><i
                                                data-feather="file-plus"></i> Paid Orders</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('polyorder.orders', ['status' => 'cancelled']) }}"><i
                                                data-feather="file-plus"></i> Cancelled Orders</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            <a href="#sidebar-boosting" data-bs-toggle="collapse">
                                <i data-feather="upload"></i>
                                <span> Boosting payment </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-boosting">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('boostorder.orders', ['status' => 'processing']) }}"><i
                                                data-feather="file-plus"></i> Processing Orders</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('boostorder.orders', ['status' => 'paid']) }}"><i
                                                data-feather="file-plus"></i> Paid Orders</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('boostorder.orders', ['status' => 'cancelled']) }}"><i
                                                data-feather="file-plus"></i> Cancelled Orders</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            <a href="#sidebar-payments" data-bs-toggle="collapse">
                                <i data-feather="cast"></i>
                                <span> Account Payment </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-payments">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('customers.payment', ['status' => 'pending']) }}"><i
                                                data-feather="file-plus"></i> Pending Payment</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customers.payment', ['status' => 'paid']) }}"><i
                                                data-feather="file-plus"></i> Paid Payment</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customers.payment', ['status' => 'cancelled']) }}"><i
                                                data-feather="file-plus"></i> Cancelled Payment</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <!-- nav items end -->
                        <li>
                            <a href="#sidebar-specialoffer" data-bs-toggle="collapse">
                                <i data-feather="gift"></i>
                                <span> Special Offer </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-specialoffer">
                                <ul class="nav-second-level">

                                    <li>
                                        <a href="{{ route('specialoffer.create') }}"><i data-feather="file-plus"></i>
                                            Create</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('specialoffer.index') }}"><i data-feather="file-plus"></i>
                                            Manage</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <!-- nav items end -->
                        <li>
                            <a href="#sidebar-reseller" data-bs-toggle="collapse">
                                <i data-feather="users"></i>
                                <span> Uddokta</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-reseller">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('customers.index', ['type' => 1, 'status' => 'pending']) }}"><i
                                                data-feather="file-plus"></i> Pending Uddokta </a>
                                    </li>
                                    <li>
                                        <a
                                            href="{{ route('customers.index', ['type' => 1, 'status' => 'active', 'activation' => 'expired']) }}"><i
                                                data-feather="file-plus"></i> Expired Uddokta </a>
                                    </li>

                                    <li>
                                        <a href="{{ route('customers.index', ['type' => 1, 'status' => 'active']) }}"><i
                                                data-feather="file-plus"></i> All Uddokta </a>
                                    </li>
                                    <li>
                                </ul>
                            </div>
                        ...
                        <!-- col end  -->
                        <li>
                            <a href="#sidebar-whole" data-bs-toggle="collapse">
                                <i data-feather="user-plus"></i>
                                <span> Re-Seller</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-whole">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('customers.index', ['type' => 2, 'status' => 'pending']) }}"><i
                                                data-feather="file-plus"></i> Pending Re-Seller </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customers.index', ['type' => 2, 'status' => 'active']) }}"><i
                                                data-feather="file-plus"></i> All Re-Seller </a>
                                    </li>
                                    <li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-customer">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('customers.index', ['type' => 0, 'status' => 'pending']) }}"><i
                                                data-feather="file-plus"></i> Pending Customer </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customers.index', ['type' => 0, 'status' => 'active']) }}"><i
                                                data-feather="file-plus"></i> All Customer </a>
                                    </li>
                                    <li>
                                </ul>
                            </div>
                        ...
                        <li>
                            <a href="#sidebar-withdraw" data-bs-toggle="collapse">
                                ...
                                <span>Uddokta Withdraw </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-withdraw">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('admin.withdraw', 'pending') }}">Pending Withdraw</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.withdraw', 'paid') }}">Paid Withdraw</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.withdraw', 'cancel') }}">Cancel Withdraw</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <!-- nav items -->
                        <li>
                            <a href="#sidebar-sellerwithdraw" data-bs-toggle="collapse">
                                <i data-feather="dollar-sign"></i>
                                <span>Seller Withdraw </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-sellerwithdraw">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('admin.ventorwithdraw', 'pending') }}">Pending Withdraw</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.ventorwithdraw', 'paid') }}">Paid Withdraw</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.ventorwithdraw', 'cancel') }}">Cancel Withdraw</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <!-- nav items -->
                        <li>
                            <a href="#sidebar-wallet" data-bs-toggle="collapse">
                                <i data-feather="server"></i>
                                <span> Wallet Manage </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-wallet">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('wallet.index', ['status' => 'pending']) }}"><i
                                                data-feather="file-plus"></i> Pending Request</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('wallet.index', ['status' => 'paid']) }}"><i
                                                data-feather="file-plus"></i> Paid Request</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('wallet.history') }}"><i data-feather="file-plus"></i>
                                            Wallet History</a>
                                    </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="siebar-sitesetting">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('settings.index') }}"><i data-feather="file-plus"></i> General
                                    Setting</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('socialmedias.index') }}"><i data-feather="file-plus"></i> Social
                                    Media</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('districts.index') }}"><i data-feather="file-plus"></i> Shipping
                                    Charge</a>
                            </li>
                            <li>
                                <a href="{{ route('freeshipping.index') }}"><i data-feather="file-plus"></i> Free
                                    Shipping</a>
                            </li>
                            <li>
                                <a href="{{ route('orderstatus.index') }}"><i data-feather="file-plus"></i> Order
                                    Status</a>
                            </li>
                            <li>
                                <a href="{{ route('registrationcharges.index') }}"><i
                                        data-feather="file-plus"></i>Registration Charge</a>
                            </li>
                            <li>
                                <a href="{{ route('newsticker.index') }}"><i
                                        data-feather="file-plus"></i>Newsticker</a>
                            </li>
                            <li>
                                <a href="{{ route('sellersms.index') }}"><i data-feather="file-plus"></i>Seller
                                    Report</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebar-api-integration">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('smsgeteway.manage') }}"><i data-feather="file-plus"></i> SMS
                                    Gateway</a>
                            </li>
                            <li>
                                <a href="{{ route('courierapi.manage') }}"><i data-feather="file-plus"></i> Courier
                                    API</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebar-pixel-gtm">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('tagmanagers.index') }}"><i data-feather="file-plus"></i> Tag
                                    Manager</a>
                            </li>
                            <li>
                ...
                <!-- nav items end -->
                <li>
                    <a href="#siebar-sliders" data-bs-toggle="collapse">
                        <i data-feather="sliders"></i>
                        <span> Slider </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="siebar-sliders">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('sliders.create') }}">New</a>
                            </li>
                            <li>
                                <a href="{{ route('sliders.index') }}">All Manage</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="siebar-banner">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('banners.index') }}"><i data-feather="file-plus"></i> Banner &
                                    Ads</a>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- nav items end -->
                <li>
                    <a href="#siebar-package" data-bs-toggle="collapse">
                        <i data-feather="codepen"></i>
                        <span> All Poly Packages </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="siebar-package">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('package_category.index') }}"><i data-feather="file-plus"></i>
                                    Package Category</a>
                            </li>
                            <li>
                                <a href="{{ route('packages.index') }}"><i data-feather="file-plus"></i> Package </a>
                            </li>
                        </ul>
                    </div>
                </li>
                <!-- nav items end -->
                <li>
                    <a href="#siebar-boostpackage" data-bs-toggle="collapse">
                        <i data-feather="git-pull-request"></i>
                        <span> Boost Package </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="siebar-boostpackage">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('boosts.index') }}"><i data-feather="file-plus"></i>
                                    Boost Package </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li>
                    ...
                    <div class="collapse" id="siebar-service">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('services.index') }}"><i data-feather="file-plus"></i> Our
                                    Service</a>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- nav items end -->
                <li>
                    <a href="#siebar-video" data-bs-toggle="collapse">
                        <i data-feather="airplay"></i>
                        <span> Registration Video </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="siebar-video">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('video_category.index') }}"><i data-feather="file-plus"></i>
                                    Video Category</a>
                            </li>
                            <li>
                                <a href="{{ route('video.index') }}"><i data-feather="file-plus"></i> Registration videos</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="siebar-expense">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('expensecategories.index') }}"><i data-feather="file-plus"></i>
                                    Expense Categories</a>
                            </li>
                            <li>
                                <a href="{{ route('expense.index') }}"><i data-feather="file-plus"></i> Expense</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sitebar-report">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('admin.stock_report') }}"><i data-feather="file-plus"></i> Stock
                                    Report</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.order_report') }}"><i data-feather="file-plus"></i> Sales
                                    Reports</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('admin.reseller_cash_report') }}"><i data-feather="file-plus"></i>
                                    Uddokta Cash</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('customers.ip_block') }}"><i data-feather="file-plus"></i> IP
                                    Block</a>
                            </li>
                        </ul>
                    </div>
