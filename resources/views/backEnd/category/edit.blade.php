                ...
                <form action="{{route('categories.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            <label for="image" class="form-label">Image (150x150px)*</label>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control @error('banner_image') is-invalid @enderror" name="banner_image" value="{{ $edit_data->banner_image }}"  id="banner_image" >
                            <img src="{{asset($edit_data->banner_image)}}" alt="" class="edit-image">
                            @error('banner_image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
